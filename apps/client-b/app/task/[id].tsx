  ...
  if (!selectedAssignment || !selectedTask) {
    return (
      <View style={styles.container}>
        <Text style={styles.errorText}>Service item not found</Text>
        <Button
          title="Go Back"
          onPress={() => router.back()}
    ...
    <ScrollView style={styles.container}>
      <Card style={styles.card}>
        ...
        <View style={styles.formFieldsContainer}>
          <Text style={styles.formFieldsTitle}>Service Checklist:</Text>
        ...
        {selectedTask.status === "completed" && selectedTask.formData && (
          <View style={styles.completedContainer}>
            <Text style={styles.completedTitle}>Service Report:</Text>
